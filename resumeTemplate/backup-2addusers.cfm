    ...
    <tbody>
      ...
      <cfloop query = "variables.qDetails">          
        <tr class="#variables.qDetails.Id#">                              
          ...
          <td class="SourceFile" multipleFileId="#variables.qDetails.Id#"><i class="fa fa-file" ></i></td>
          <td> 
            <div class="col-md-3">
              <button class="btn btn-outline-success btn-sm editBtn" dbId="#variables.qDetails.Id#"><i class="fa fa-edit fa-1x " ></i></button> 
            </div>
          </td>                                                                                                                
        </tr>                               
      </cfloop>   
              ...
              <div class="container-fluid">
                ...
                <div class="row mt-3">
                  ...
                  <div class=" col-md-4">
                    ...
                    <input type="text" class="form-control text-secondary" value='' id="dnumber" name="dnumber" maxlength="10">
                  </div>  
                </div>
                <div class="row mt-3">
...
<script>
  $(document).ready( function () {  
    $(".SourceFile").click(function() { 
      multifileId=$(this).attr('multipleFileId')  
        ...
        $.ajax({
          ...
          type: "get",
          data: {
            allFiles:$(this).attr("multipleFileId")                                                  
          },
