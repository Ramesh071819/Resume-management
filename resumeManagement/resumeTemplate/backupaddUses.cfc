<cfcomponent>
    ...
    <cffunction  name="FiltergetCandidateDetails" access="remote" returnformat="JSON"  returnType="query">  
        ...
        <cfquery name="qfilterdetails" datasource="Resume-Management">             
                SELECT  candidatedinfo.Qualification,candidatedinfo.Department,candidatedinfo.FirstName,candidatedinfo.MiddleName,candidatedinfo.LastName,candidatedinfo.Email,candidatedinfo.Gender,candidatefiles.FilePath,candidatefiles.FileName,candidatedinfo.Id
                FROM  candidatedinfo 
    ...
    <cffunction  name="getCandidateDetails" access="public">       
        <cfquery name="qdetails" datasource="Resume-Management">             
                SELECT  candidatedinfo.FirstName,candidatedinfo.Id,candidatedinfo.MiddleName,candidatedinfo.LastName,candidatedinfo.Email,candidatedinfo.CurrentCTC,candidatedinfo.City,candidatedinfo.PhoneNumber,candidatedinfo.State,candidatedinfo.PresentAddress,candidatefiles.FilePath,candidatefiles.FileName,candidatedinfo.MobileNumber
                FROM  candidatedinfo 
                INNER JOIN  candidatefiles ON  candidatefiles.candidateId = candidatedinfo.Id                           
        </cfquery>   
        <cfreturn qdetails>
    ...
    <cffunction  name="UpdateSingleCandidateDetails" access="remote" returnformat="JSON">
        ...
        <cfargument  name="uploadedFiles"  required="true">
        <cfargument  name="uploadedFileName"  required="true">
        ...
        <cfargument name="hrpwd"  required="true">
         <cfargument name="hrname"  required="true">
            <cfquery name="qhrdetails" datasource="Resume-Management">
                insert into hrlogindetails(Email,Password,Name)
                values(
